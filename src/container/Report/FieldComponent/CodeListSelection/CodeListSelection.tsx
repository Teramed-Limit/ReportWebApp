...
import { SelectionField } from '../../../../interface/report-field/selection-field';
...
const CodeListSelection = React.forwardRef(
    (
        ...
        const options = optionStore.getCodeList(optionSource, filterCondition);
        ...
        }, [onSelectionChanged, optionStore]);
